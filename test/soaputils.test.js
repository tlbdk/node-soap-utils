...
describe('Generate sample Request/Response json/xml', () => {
  let wsdl_sample = fs.readFileSync(
    __dirname + '/../examples/StockQuote.wsdl',
    'utf8'
  )
  ...
  it('generateSampleRequest', () => {
    ...
    let soapUtils = new SoapUtils(wsdl_sample)
    let generatedRequest = soapUtils.generateSampleRequest(
      'StockQuoteService',
      'StockQuoteBinding',
      'GetLastTradePrice'
    )
  ...
  it('generateSampleResponse', () => {
    ...
    let soapUtils = new SoapUtils(wsdl_sample)
    let generatedResponse = soapUtils.generateSampleResponse(
      'StockQuoteService',
      'StockQuoteBinding',
      'GetLastTradePrice'
    )
